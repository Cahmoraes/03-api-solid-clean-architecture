...
describe('UniqueIdentity', () => {
  ...
  it('should return true when toEquals is called with different UniqueIdentity with same ID', () => {
    const id1 = 'fake-id-1'
    const id2 = 'fake-id-1'
  ...
  it('should return false when toEquals is called with different UniqueIdentity', () => {
    const id1 = 'fake-id-1'
    const id2 = 'fake-id-2'
    const uniqueIdentity1 = new UniqueIdentity(id1)
    const uniqueIdentity2 = new UniqueIdentity(id2)
  ...
  it('should return false when toEquals is called with different Object', () => {
    const id1 = 'fake-id-1'
    const uniqueIdentity1 = new UniqueIdentity(id1)
